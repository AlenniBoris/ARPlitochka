# План серверного слоя, моков и тестирования
...
## Переключатель моков в рантайме
...
## Общие плитки и функционал каталога
...
А роутинг DSL должен повторять бизнес-вложенность запросов:
...
Mock-ассеты для плитки должны жить в `:mock:tiles`, а не в feature-модуле AR:
