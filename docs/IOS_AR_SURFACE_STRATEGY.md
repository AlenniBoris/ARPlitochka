...
Ссылки: [ARKit Documentation](https://developer.apple.com/documentation/arkit), [ARKit Overview](https://developer.apple.com/augmented-reality/arkit/).
...
| **B0.5** | Status panel: **Под прицелом** / **Крупнейшая поверхность** | ✅ | `ArStatusPanel.kt`, `IosArScreen.ios.kt` |
